...
wp_enqueue_style('sudaraka_org_category-note-to-self', get_template_directory_uri() . '/css/category-note-to-self.css', null, null);

get_header();

?>
				<div id="body-content" class="category notes">
					...
					<?php
						...
						while(have_posts()) {
							...
							the_post();
							get_template_part('content-note-to-self', get_post_format());
						}
